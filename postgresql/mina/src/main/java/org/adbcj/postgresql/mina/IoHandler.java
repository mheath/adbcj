...
import org.adbcj.postgresql.codec.PasswordHash;
...
import org.adbcj.postgresql.mina.PgException;
...
public class IoHandler extends IoHandlerAdapter {
	...
	private void doReadyForQuery(IoSession session, ReadyMessage backendMessage) {
		...
		MinaConnectionManager.PgConnectFuture future = connection.getConnectFuture();
		if (!future.isDone()) {
